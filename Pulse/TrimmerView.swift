...
public class TrimmerView: AssetTimeSelector {
    ...
    deinit {
        leftHandleView.removeGestureRecognizer(leftPanGestureRecognizer)
        rightHandleView.removeGestureRecognizer(rightPanGestureRecognizer)
