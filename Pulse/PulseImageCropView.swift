...
final class PulseImageCropView: UIScrollView, UIScrollViewDelegate, UIGestureRecognizerDelegate {
    ...
    var cropArea:CGRect{
        get{
            let factor = image.size.height / frame.height
            ...
            let height = frame.size.height * scale * factor
